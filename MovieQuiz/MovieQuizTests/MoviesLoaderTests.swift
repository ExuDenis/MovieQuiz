...
//  MovieQuizTests
//
//  Created by Денис Филатов on 08.08.2024.
//
...
class MoviesLoaderTests: XCTestCase {
    ...
    func testFailureLoading() throws {
        // Тестовый сценарий для неудачной загрузки фильмов по сети
...
struct StubNetworkClient: NetworkRouting {
    // Заглушка для сервиса взаимодействия с сетью
